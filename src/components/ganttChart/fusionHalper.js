export const processesFn = (data) => {
  return data.map((item, index) => ({ label: item?.name, id: index+1+'' }));
};

export const taskFn = (data) => {
  let tasks = [];
  ...
  const actEnddate = new Date(element?.endActual);

    tasks.push({
      label: "Planned",
      processid: ind + 1, // sequence of process
    ...
    tasks.push({
      ...
      processid: ind + 1, // sequence of process
      start: (startdate.getMonth() + 1) + '/' + startdate.getDate() + '/' +  startdate.getFullYear(),
      end: (actEnddate.getMonth() + 1) + '/' + actEnddate.getDate() + '/' +  actEnddate.getFullYear(),
      id: element?.id + "-" + ind,
      color: "#6baa01",
      toppadding: "56%", //for gap
      height: "32%",
    });
  });
  console.log('tasks',tasks);
...
export const taskData = [
  {
    label: "Planned",
    processid: "1", // sequence of process
    start: "9/4/2014",
    end: "12/4/2014",
    id: "1-1",
    color: "#008ee4",
  ...
  {
    label: "Actual",
    processid: "2", // sequence of process
    start: "13/4/2014",
    end: "25/4/2014",
    id: "2",
    color: "#6baa01",
  ...
  },
  {
    ...
    toppadding: "56%",
    height: "32%",
    tooltext: "Delayed by 2 days.", //delay difference
  },
  {
    label: "Planned",
    processid: "3",
